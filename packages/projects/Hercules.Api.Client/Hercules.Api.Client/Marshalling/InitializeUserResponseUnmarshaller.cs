//-----------------------------------------------------------------------
// <copyright file="InitializeUserResponseUnmarshaller.cs" company="ChessDB.AI">
// MIT Licensed.
// </copyright>
//-----------------------------------------------------------------------
...
namespace Hercules.Api.Client.Marshalling
{
    ...
    {
        private static InitializeUserResponseUnmarshaller instance = new InitializeUserResponseUnmarshaller();
