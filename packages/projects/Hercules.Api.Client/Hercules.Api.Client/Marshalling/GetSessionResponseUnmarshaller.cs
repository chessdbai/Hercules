//-----------------------------------------------------------------------
// <copyright file="GetSessionResponseUnmarshaller.cs" company="ChessDB.AI">
// MIT Licensed.
// </copyright>
//-----------------------------------------------------------------------
...
namespace Hercules.Api.Client.Marshalling
{
    ...
    {
        private static GetSessionResponseUnmarshaller instance = new GetSessionResponseUnmarshaller();
