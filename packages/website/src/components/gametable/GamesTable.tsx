...
export default class GamesTable extends Component<GamesTableProps,GamesTableState> {
  ...
  invokeSkillsFilterMethod = () => {
      this.api.getFilterInstance('skills', (instance: any) => {
  ...
  static countryCellRenderer(params: any) {
      if (params.value) {
  ...
  static dateCellRenderer(params: any) {
      return GamesTable.pad(params.value.getDate(), 2) + '/' +
          GamesTable.pad(params.value.getMonth() + 1, 2) + '/' +
          params.value.getFullYear();
  }

  static pad(num: any, totalStringSize: any) {
      let asString = num + "";
                      ...
                      <AgGridReact
                          ...
                          <AgGridColumn headerName="Employee" headerGroupComponentFramework={HeaderGroupComponent}>
                              ...
                              <AgGridColumn field="country" width={150}
                                            cellRenderer={GamesTable.countryCellRenderer as any}
                                            filterParams={{
                                                cellRenderer: GamesTable.countryCellRenderer,
                                                cellHeight: 20
                                            }}
                                            enableRowGroup enablePivot pinned editable/>
                              <AgGridColumn field="dob" width={175} headerName="DOB" filter="agDateColumnFilter"
                                            pinned columnGroupShow="open"
                                            cellRenderer={GamesTable.dateCellRenderer as any}/>
                          </AgGridColumn>
