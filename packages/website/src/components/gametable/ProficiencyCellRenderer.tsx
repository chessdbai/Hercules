...
interface ProficiencyCellRendererProps {
  value: number
}

interface ProficiencyCellRendererState {
...
export default class ProficiencyCellRenderer
    extends React.Component<ProficiencyCellRendererProps,ProficiencyCellRendererState> {
