...
type Sorted = 'desc' | 'asc' | '';

interface SortableHeaderComponentProps {
  column: any,
  enableSorting: boolean,
  enableMenu: boolean,
  displayName: string,
  menuIcon: string,
  setSort: (sorted: Sorted, e: any) => void,
  showColumnMenu: (e: any) => void
}

interface SortableHeaderComponentState {
  sorted: Sorted
}

// Header component to be used as default for all the columns.
export default class SortableHeaderComponent
    extends React.Component<SortableHeaderComponentProps,SortableHeaderComponentState> {

    constructor(props: SortableHeaderComponentProps) {
        super(props);
    ...
    onSortRequested(order: Sorted, event: any) {
