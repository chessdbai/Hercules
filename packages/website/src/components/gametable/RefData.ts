...
export default class RefData {
  ...
  public static FIRST_NAMES : string[];
  public static LAST_NAMES : string[];
  public static COUNTRY_CODES : {
    [country: string] : string
  };
  public static COUNTRIES : CountryInfo[];
  public static ADDRESSES : string[];
  public static DOB : Date[];
  public static IT_SKILLS : string[];
  public static IT_SKILLS_NAMES : string[];
}
