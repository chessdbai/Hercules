...
type TextBoxDate = string | Date | null;
interface DateComponentProps {
  onDateChanged: (d?: TextBoxDate) => void
}
...
export default class DateComponent
  extends React.Component<DateComponentProps,DateComponentState> {
    ...
    updateAndNotifyAgGrid(date: TextBoxDate, textBoxes: Textboxes) {
        this.setState({
                date: date,
                textBoxes: textBoxes
            },
    ...
    onDateChanged() {
        let date = this.parseDate((this.refs.dd as any).value, (this.refs.mm as any).value, (this.refs.yyyy as any).value);
        let textBoxes = {
            dd: (this.refs.dd as any).value,
            mm: (this.refs.mm as any).value,
            yyyy: (this.refs.yyyy as any).value,
        };
    ...
    parseDate(dd: TextBoxDate, mm: TextBoxDate, yyyy: TextBoxDate) {
        //If any of the three input date fields are empty, stop and return null
        if (dd!.toString().trim() === '' || mm!.toString().trim() === '' || yyyy!.toString().trim() === '') {
            return null;
        }
